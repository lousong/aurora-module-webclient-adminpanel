      ...
      <q-card flat bordered class="card-edit-settings">
        <q-card-section>
          <div class="row q-mb-md">
            ...
            <div class="col-5">
              <q-input outlined dense class="bg-white" bg-color="white" v-model="login" @keyup.enter="save" />
            </div>
          </div>
          <div class="row q-mb-md">
            <div class="col-2 q-my-sm" v-t="'ADMINPANELWEBCLIENT.LABEL_SECURITY_PASS'"></div>
            <div class="col-5">
              <q-input outlined dense class="bg-white" bg-color="white" ref="oldPassword" type="password" autocomplete="new-password" v-model="oldPassword"
                       @keyup.enter="save" />
            </div>
          </div>
          <div class="row q-mb-md">
            ...
            <div class="col-5">
              <q-input outlined dense class="bg-white" bg-color="white" ref="newPassword" autocomplete="new-password" v-model="newPassword" type="password"
                       @keyup.enter="save" />
            </div>
          </div>
          <div class="row q-mb-md">
            ...
            <div class="col-5">
              <q-input outlined dense class="bg-white" bg-color="white" v-model="confirmNewPassword" type="password"
